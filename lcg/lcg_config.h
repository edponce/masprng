...
#else
    const int INIT_SEED[2] __attribute__ ((aligned(SIMD_ALIGN))) = {2868876, 16651885};
    // The following is done since the multiplier is stored in pieces of 12 bits each
    const int MULT[7][4] __attribute__ ((aligned(SIMD_ALIGN))) = {{0x175,0xe7b,0x5a2,0x287}, {0x66d,0xece,0x5de,0x000}, {0x265,0x605,0xc44,0x3ea}, {0x9f5,0x9cc,0x142,0x1ee}, {0xbbd,0xeb4,0xb38,0x275}, {0x605,0xb08,0xa9c,0x739}, {0x5f5,0xcc2,0x8d7,0x322}};
#endif
